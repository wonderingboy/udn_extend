...
%
    ...
    ip.addParamValue('scales',          800,            @ismatrix);
    % Max pixel size of a scaled input image
    ip.addParamValue('max_size',        1066,           @isscalar);
    % Images per batch
    ...
    %% testing
    ip.addParamValue('test_scales',     800,            @isscalar);
    ip.addParamValue('test_max_size',   1066,           @isscalar);
